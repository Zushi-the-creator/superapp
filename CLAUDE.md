...
- **MODEL**: Production runs **ATLAS V2.7 (MR entries) + V3.0 (cache-accelerated evaluator) + V3.3 (regime-adaptive entry sizing, 2026-06-12) + V3.4 (Buffered WR scoring, 2026-06-16) + V3.5 (Entries tab sorts by composite_score, not Buffered WR, 2026-06-18) + V3.6 (Fixed42d MR/BOTH exit, 2026-07-22 — replaces V3.4 Fixed60d after a 17-window rolling walk-forward on clean Tiingo data: Fixed42 beats Fixed60 on every metric; DEPLOYED + verified live. RE-VERIFIED 2026-07-31 after the harness regime fix — over 17 windows vs 6 exit families: Fixed42 avg +2.9% / median +6.2% / compounded +20.4% / worst -26.1%, vs Fixed60 avg +1.4% / median -6.8% / compounded -18.7% / worst -30.9%. The pre-fix headline figures (8/17 wins, +30.8% vs -26.1%) no longer reproduce exactly; the ranking does.)**. There is no single "version" — the deployed code is a hybrid. See "Active Strategy" section below for the actual rules.
